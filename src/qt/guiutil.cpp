...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("cryptotest://"))
    {
        uri.replace(0, 11, "cryptotest:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Cryptotest.lnk";
}
...
{
    return GetAutostartDir() / "cryptotest.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Cryptotest-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  cryptotest-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Cryptotest-Qt"));
